...
public class Reon extends BaseResolutionPolicy {
	// ===========================================================
	// Fields
	// ===========================================================
	...
	public Reon(final float nCameraWidth, final float nCameraHeight) {
	...
	public void onMeasure(RenderSurfaceView pRenderSurfaceView,
		...
		pRenderSurfaceView.setMeasuredDimensionProxy(measuredWidth,
				measuredHeight);
	}
}

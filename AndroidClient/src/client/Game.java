...
public class Game extends SimpleBaseGameActivity {
	...
	protected void onCreateResources() {
		...
		hpTexture = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "hp.png", 500, 1500);
...
//						===============================================================
						...
						if (!sprites.containsKey(players.get(i).getID())) {
							...
							Sprite hp = new Sprite(sprite.getX(), sprite.getY()-sprite.getHeight()*0.1f, players.get(i).getHealth()*2, 15, hpTexture, getVertexBufferObjectManager());
							if (client.getID().equalsIgnoreCase(players.get(i).getID())) {
							...
							if (!client.getID().equalsIgnoreCase(players.get(i).getID())) {
								hp.setPosition(sprite.getX(), sprite.getY()-sprite.getHeight()*0.1f);
								hp.setSize(players.get(i).getHealth(), 10);
							} else {
